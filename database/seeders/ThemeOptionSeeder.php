    ...
    public function run()
    {
        ...
        $data = [
            'en_US' => [
                ...
                [
                    'key'   => 'copyright',
                    'value' => '©' . now()->format('Y') . ' Nagarik Aawash. All rights reserved by TheSky9.',
                ],
                [
                    'key'   => 'homepage_id',
                    'value' => '1',
                ...
                [
                    'key'   => 'site_title',
                    'value' => 'Nagarik Aawash - Laravel Real Estate Multilingual Syste',
                ],
                [
                    'key'   => 'seo_description',
                    'value' => 'Nagarik Aawash is a premium real estate related websites build on Laravel. With an advanced admin dashboard that will help you create a local or global real-estate directory site.',
                ],
                [
                    'key'   => 'seo_og_image',
            ...
            'vi' => [
                ...
                [
                    'key'   => 'copyright',
                    'value' => '©' . now()->format('Y') . ' Nagarik Aawash. Tất cả quyền đã được bảo hộ bởi TheSky9.',
                ],
                [
                    'key'   => 'cookie_consent_message',
