...
namespace Theme\Nagarikaawash\Http\Controllers;
...
use SlugHelper;
use Theme;
use Theme\Nagarikaawash\Http\Resources\AgentHTMLResource;
use Theme\Nagarikaawash\Http\Resources\PostResource;
use Theme\Nagarikaawash\Http\Resources\PropertyHTMLResource;
use Theme\Nagarikaawash\Http\Resources\PropertyResource;
use Theme\Nagarikaawash\Http\Resources\ReviewResource;
use Theme\Nagarikaawash\Http\Resources\TestimonialResource;

class NagarikaawashController extends PublicController
{
    /**
     * @param string            $key
