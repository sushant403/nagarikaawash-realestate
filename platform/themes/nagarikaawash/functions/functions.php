...
use Theme\Nagarikaawash\Http\Requests\CityRequest;
use Botble\Theme\Supports\Youtube;
use Theme\Nagarikaawash\Forms\Fields\ThemeIconField;
...
register_sidebar([
    ...
    'description' => __('Footer sidebar 1 for Nagarik Aawash'),
]);

register_sidebar([
    'id'          => 'footer_sidebar_2',
    'name'        => __('Footer sidebar 2'),
    'description' => __('Footer sidebar 2 for Nagarik Aawash'),
]);

register_sidebar([
    'id'          => 'footer_sidebar_3',
    'name'        => __('Footer sidebar 3'),
    'description' => __('Footer sidebar 3 for Nagarik Aawash'),
]);

register_sidebar([
    'id'          => 'property_sidebar',
    'name'        => __('Property sidebar'),
    'description' => __('Property sidebar for Nagarik Aawash'),
]);
